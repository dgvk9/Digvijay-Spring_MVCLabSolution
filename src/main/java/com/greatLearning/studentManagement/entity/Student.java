...
public class Student {
	 ...
	 * IDENTITY: Hibernate relies on an auto-incremented database column to generate
	 * the primary key, SEQUENCE: Hibernate requests the primary key value from a
	 * database sequence, TABLE: Hibernate uses a database table to simulate a
	 * sequence.
	 */
